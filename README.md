...
Business Questions
What were the order counts, sales, and average order value (AOV) for MacBooks sold in North America, broken down by quarter across all years?
For products purchased in 2022 on the website, or on mobile in any year, which region has the highest average delivery time?
What was the refund rate and refund count for each product overall?
Within each region, what is the most popular product?
How does time-to-first-purchase differ between loyalty and non-loyalty customers?
Data
...
Files
#	Question	File
1	MacBook quarterly sales & AOV in North America	macbook_quarterly_sales_na.sql
2	Average delivery time by region (2022 website + all-year mobile)	avg_delivery_time_by_region.sql
3	Refund rate and refund count by product	refund_rate_by_product.sql
4	Most popular product per region	top_product_by_region.sql
5	Time to first purchase: loyalty vs. non-loyalty customers	purchase_time_loyalty_vs_nonloyalty.sql
Summary of Insights
